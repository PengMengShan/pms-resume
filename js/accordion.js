...
(function($) {
   var Accordion = function(obj, option) {
      ...
      this.defaults = {
         ...
         animateHeight: 200,
         response: true,
         styleColor: { "background": "rgba(0,0,0,.5)", "font": "#333333", "textShadow": "0px 0px 1px green" },
         animateTime: "0.5s"
      };
      ...
      defaultDOM: function() {
         ...
         $.each(imgArr, function(index, val) {
            ...
            liHtml +=
               ...
               '<p class="accordion-content" style="color:#fff;">' + val.content + '</p>' +
               '</div>' +
               '</li>';
         });
